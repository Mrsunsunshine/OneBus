		...
		<div id="content" class="xgrid">
				...
				<div class="accordion_container">
					...
					<div class="block">
						...
						<form action="/onebus/main/video" method="post"
							class="form label-inline uniform">
							<div class="field">
								<label for="bus">选择公交车辆 :</label> <select name="busId">
									<c:forEach var="bus" items="${buss}">
										<!-- <td>${bus.getPlateNumber()}</td> -->
										<option value='${bus.getId()}'>${bus.getBusLine().getLineNumber()}
											的 ${bus.getPlateNumber()}</option>
									</c:forEach>
								</select>
							</div>
							<br />
