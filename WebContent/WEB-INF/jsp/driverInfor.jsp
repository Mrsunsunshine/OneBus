...
<script type="text/javascript">
	function queren(number) {
		var se = confirm("你确定删除工号为："+number+"的司机？");
		if (se == true) {	
			return true;
		} else {
			return false;
	...
	<div id="wrapper">
		...
		<div id="masthead">
			...
			<div class="content_pad">
				...
				<div id="bread_crumbs">
					<a >信息管理</a> / <a class="current_page">司机信息</a>
				</div>
				<!-- #bread_crumbs -->
		...
		<div id="content" class="xgrid">
			...
			<h3 align="right">
				<a href="/onebus/main/addDriver">添加新司机</a>
			</h3>
						...
						<tbody id="table2">
							<c:forEach var="driver" items="${drivers}">
								<tr class="success">
									...
									<td>${driver.getAge()}</td>
									<td>${driver.getSex()}</td>
									<td>${driver.getCompany().getName()}</td>
									<td><a
										href="/onebus/main/deleteDriver?number=${driver.getNumber()}"
										onclick="return queren(${driver.getNumber()})"><img
											style="display: block; width: 25%; align: center;"
											src="../images/map_delete.png" /></a></td>
									<td><a
										href="/onebus/main/editDriver?number=${driver.getNumber()}"><img
