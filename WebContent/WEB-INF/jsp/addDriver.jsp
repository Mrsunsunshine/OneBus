...
<script type="text/javascript">
	...
	function driver_info() {
		...
		if (document.submitDriver.number.value == "") {
			alert("工号不能为空！");
			document.submitDriver.number.focus();
			return false;
		}

		if (document.submitDriver.name.value == "") {
			alert("姓名不能为空！");
			document.submitDriver.name.focus();
			return false;
		}

		if (document.submitDriver.age.value == "") {
			alert("年龄不能为空！");
			document.submitDriver.age.focus();
			return false;
		}

		var age = document.submitDriver.age.value;
		if (!isNaN(age)) {
			if (age<26 || age>60) {
			...
			<div class="content_pad">
				...
				<div id="bread_crumbs">
					<a>信息管理</a> / <a href="/onebus/main/driverInfor"
						class="current_page">司机信息</a> / <a class="current_page">添加司机</a>
				</div>
				<!-- #bread_crumbs -->
		...
		<div id="content" class="xgrid">
			...
			<div class="x9">
				...
				<div class="accordion_container">
					...
					<div class="block">
						<form action="/onebus/main/submitDriver" method="post"
							class="form label-inline uniform" name="submitDriver"
							onsubmit='return driver_info()'>

							<div class="field">
								<label for="number">工号 </label> <input id="number" name="number"
									size="50" type="text" class="medium" placeholder="请输入工号" />
							</div>

							<div class="field">
								<label for="name">姓名 </label> <input id="name" name="name"
									size="50" type="text" class="medium" placeholder="请输姓名" />
							</div>

							<div class="field">
								<label for="age">年龄 </label> <input id="age" name="age"
									size="50" type="text" class="medium" placeholder="请输年龄" />
							</div>
