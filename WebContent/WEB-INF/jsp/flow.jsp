	...
	<div id="wrapper">
		...
		<div id="content" class="xgrid">
			...
			<div class="accordion_container">
					...
					<div class="field">
						<font size="4"><label for="lineName">线路名: </label>
							${lineNumber}</font>
					</div><br>
					<div class="field">
						<font size="4"><label for="plateNumber">公交车辆: </label>
							${plateNumber}</font>
					</div><br>

					<div class="field">
						<font size="4"><label for="periodTime">时间段: </label>
							${periodTime}</font>
					</div><br>

					<div class="field">
						<font size="4"><label for="userNumber">客流量: </label>
							${userNumber}人次</font>
					</div><br>
