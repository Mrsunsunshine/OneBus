	...
	<div id="wrapper">
		...
		<div id="masthead">
			...
			<div class="content_pad">
				...
				<div id="bread_crumbs">
					<a>用户反馈</a> / <a class="current_page">用户意见</a>
				</div>
				<!-- #bread_crumbs -->
						...
						<tbody id="table2">
							<c:forEach var="feedback" items="${noFeedbacks}">
								<tr class="danger">
									...
									<td>未处理</td>
									<td align = "center"><a
										href="/onebus/main/userRecommendationInfor?id=${feedback.getId()}"><img
							...
							<c:forEach var="feedback" items="${doFeedbacks}">
								<tr class="success">
									...
									<td>已处理</td>
									<td align = "center"><a
										href="/onebus/main/userRecommendationInforDo?id=${feedback.getId()}"><img
											style="display: block; width: 25%; align: center;"
											src="../images/information.png" /></a></td>
								</tr>
							</c:forEach>
