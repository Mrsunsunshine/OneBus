			...
			<div class="content_pad">
				...
				<div id="bread_crumbs">
					<a>用户反馈</a> / <a href="/onebus/main/userComplaint"
						class="current_page">用户投诉</a> /投诉详情
				</div>
				<!-- #bread_crumbs -->
		...
		<div id="content" class="xgrid">
			...
			<div class="x9">
				...
				<div class="accordion_container">
					...
					<div class="block">
						<form action="/onebus/main/userComplaint" method="post"
							class="form label-inline uniform" name="setInformation">


							<div class="field">
								<label for="fname">投诉车辆 </label> <input id="PlateNumber"
									name="PlateNumber" size="50" type="text" class="medium"
									placeholder="" value="${feedback.getBus().getPlateNumber()}"
									readonly />
							...
							<div class="field">
								<label for="time">投诉时间 </label> <input id="time" name="time"
							...
							<div class="field">
								<label for="description">状态</label> <input id="status"
									name="status" size="50" type="text" class="medium" value="已处理"
									readonly />
							</div>
							...
							<br />
							<div class="buttonrow">
								<button type="submit" class="btn btn-orange">返回</button>
							</div>
