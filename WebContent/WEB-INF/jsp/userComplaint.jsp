	...
	<div id="wrapper">
		...
		<div id="masthead">
			...
			<div class="content_pad">
				...
				<div id="bread_crumbs">
					<a>用户反馈</a> / <a class="current_page">用户投诉</a>
				</div>
				<!-- #bread_crumbs -->
			...
			<div class="accordion_container">
				...
				<div align="center">
					...
					<table border="2" id="table1" align="center"
						...
						<tbody id="table2">
							<c:forEach var="feedback" items="${noFeedbacks}">
								<tr class="danger">
									<td>${feedback.getBus().getPlateNumber()}</td>
									<td>${feedback.getUserPhone()}</td>
									<td>${feedback.getFeedbackTime()}</td>
									<td>未处理</td>									
									<td><a href="/onebus/main/userComplaintInfor?id=${feedback.getId()}"
										><img
											style="display: block; width: 25%; align: center;"
											src="../images/information.png" /></a></td>									
								</tr>
							</c:forEach>
							
							<c:forEach var="feedback" items="${doFeedbacks}">
								<tr class="success">
									<td>${feedback.getBus().getPlateNumber()}</td>
									<td>${feedback.getUserPhone()}</td>
									<td>${feedback.getFeedbackTime()}</td>
									<td>已处理</td>									
									<td><a href="/onebus/main/userComplaintInforDo?id=${feedback.getId()}"
										><img
											style="display: block; width: 25%; align: center;"
											src="../images/information.png" /></a></td>									
								</tr>
